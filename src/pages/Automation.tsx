  ...
  return (
    ...
    >
      ...
      <div className="mb-12 flex justify-between items-end">
        <div>
          <h2 className="text-4xl font-extrabold tracking-tight text-on-surface font-headline">Automatizaciones</h2>
          <p className="text-slate-500 mt-2 font-medium">Crea reglas para programar y publicar contenido en piloto automático.</p>
        </div>
